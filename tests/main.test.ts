...
describe('test serializeOptions function', () => {
	it('should serialize the given options to a query string', () => {
		expect(solarEdge.serializeOptions({ startTime: '2021-05-01 00:00:00', endTime: '2021-05-10 23:59:59' })).toBe(
			'&startTime=2021-05-01%2000%3A00%3A00&endTime=2021-05-10%2023%3A59%3A59',
		);
